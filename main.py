...
class Processor():
    ...
    def eval(self, epoch, save_score=True, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        for ln in loader_name:
            ...
            np.save('{}/epoch{}_{}_score.npy'.format(
                        self.arg.work_dir, epoch + 1, ln),score)
            ...
            if self.arg.phase == 'train':
                ...
                self.val_writer.add_scalar('acc', 22222222, self.global_step)
            ...
            score_dict = np.array(score_dict)

            if save_score:
                with open('{}/epoch{}_{}_score.npy'.format(
                        self.arg.work_dir, epoch + 1, ln), 'wb') as f:
                    np.save(f,score_dict)
